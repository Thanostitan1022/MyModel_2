...
optimizer_MyGenerator_2 = torch.optim.Adam(MyGenerator.parameters(), lr=opt_train.lr,
                                           betas=(opt_train.b1, opt_train.b2)
                                           )
optimizer_MyDiscriminator = torch.optim.Adam(MyDiscriminator.parameters(), lr=opt_train.lr,
                                             betas=(opt_train.b1, opt_train.b2))
optimizer_MyDiscriminator_2 = torch.optim.Adam(MyDiscriminator.parameters(), lr=opt_train.lr,
                                               betas=(opt_train.b1, opt_train.b2))
