...
class GeneratorResNet_1(nn.Module):
    def __init__(self, input_shape):  # (input_shape_A 和 input_shape_B = (3, 256, 256),
        ...
        out_features = out_features // 2  # out_features = 64
        ...
        out_features = out_features // 2  # out_features = 32
        ...
        in_features = out_features  # in_features = 32
        out_features = out_features // 2  # out_features = 16
...
class Discriminator_1(nn.Module):
    def __init__(self, input_shape):
        ...
        self.model = nn.Sequential(
            *discriminator_block(channels, 32, normalize=False),  # layer += [conv(3, 32) + relu]
            *discriminator_block(32, 64),  # layer += [conv(32, 64) + norm + relu]
            ...
            *discriminator_block(128, 256),  # layer += [conv(128, 256) + norm + relu]
            ...
            # 这里就是左和上各填充一（列）行0像素
            nn.Conv2d(256, 1, kernel_size=4, padding=1)  # layer += [conv(256, 1)]
        )
